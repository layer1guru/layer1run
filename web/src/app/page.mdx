...
## NodΞRunr v24.12.15 — Windows Support {{ date: '2024-11-15T00:00Z' }}
...
## NodΞRunr v24.12.10 — E2E Encryption (by default) {{ date: '2024-12-10T00:00Z' }}
...
## NodΞRunr v24.12.5 — Automatic Network Installation {{ date: '2024-12-05T00:00Z' }}
...
- Install the most popular virtual machines
- Added new Localhost stats.
